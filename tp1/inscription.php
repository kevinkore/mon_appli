<?php
    ...
    if(!empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['depart']) && !empty($_POST['email']) && !empty($_POST['telephone']))
    {
        $requete= "INSERT INTO `personne`(`nom`, `prenom`, `depart`, `mails`, `telephone`) VALUES ('{$_POST['nom']}','{$_POST['prenom']}','{$_POST['depart']}','{$_POST['email']}','{$_POST['telephone']}')";
        $result=$exo->connex()->exec($requete); 
    }
    ...
    <div class="container d-flex h-100">
        <div class="row align-self-center">
            <form action= "<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="application/x-www-form-urlencoded">
                ...
                <table>
                    <tr><td>Nom : </td><td><input type="text" class="form-control" name="nom" size="40" maxlength="30" required/></td></tr>
                    <tr><td>Prénom : </td><td><input type="text" class="form-control" name="prenom" size="40" maxlength="30" required /></td></tr>
                    <tr><td>Departement : </td><td><input type="text" class="form-control" name="depart" size="40"  maxlength="30" required/></td></tr>
                    <tr><td>E-mail : </td><td><input type="email" class="form-control" name="email" size="40"  maxlength="60" required /></td></tr>
                    <tr><td>Telephone : </td><td><input type="tel" class="form-control" name="telephone" size="40"  maxlength="40" required/></td></tr>
                </table>
                </fieldset>
